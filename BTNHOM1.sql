USE master;
IF EXISTS (SELECT name FROM sys.databases WHERE name ='QLGH_LUY')
BEGIN   
    ALTER DATABASE QLGH_LUY SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE QLGH_LUY
END;
--Tạo database có tên QLBH-2149
create database QLGH_LUY
go
	USE QLGH_LUY
go
